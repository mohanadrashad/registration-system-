...
**Branch in progress:** none — between projects (THIRD-width fix #78 + Section Group Headers v1 #74–#76 + attendee-list QoL arc #65–#70 + edit-save fix #72 all shipped + prod-verified; open follow-ups: FILE-field has-file/no-file filtering; optional mobile-responsive field widths — THIRD/HALF stack full-width on phones (currently non-responsive); Section-Headers v2 non-goals — collapsible sections, header auto-hide when conditionally empty, section descriptions)
**Production branch:** `main`, HEAD at `2b16e2f` (THIRD-width grid fix, PR #78)
