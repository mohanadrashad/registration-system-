...
**Branch in progress:** none — between projects (debt items #80/#81 + THIRD-width #78 + Section Group Headers v1 #74–#76 + attendee-list QoL arc #65–#70 + edit-save fix #72 all shipped + prod-verified; open follow-ups: FILE-field has-file/no-file filtering; optional mobile-responsive field widths — THIRD/HALF stack full-width on phones (currently non-responsive); Section-Headers v2 non-goals — collapsible / conditional-empty-hide / descriptions; abandoned-branding-upload orphans left unswept by design)
**Production branch:** `main`, HEAD at `be6600d` (branding reconcile-on-replace, PR #81)
