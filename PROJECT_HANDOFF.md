...
**Branch in progress:** none — between projects (Section Group Headers feature v1 complete #74–#76; attendee-list QoL arc #65–#70 + edit-save fix #72 all shipped + prod-verified; open follow-ups: FILE-field has-file/no-file filtering; Section-Headers v2 non-goals — collapsible sections, header auto-hide when conditionally empty, section descriptions)
**Production branch:** `main`, HEAD at `f7898e3` (section-heading form-builder polish, PR #76)
